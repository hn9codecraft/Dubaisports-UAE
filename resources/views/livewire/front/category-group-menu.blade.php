<div>
<nav class="navbar navbar-expand-xl py-0 bg-black position-relative">
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link red-bg" href="{{ url('clearance-sale') }}">Clearance Sale</a>
                </li>
            </ul>
        </div>
    </div>
</nav>
<a class="btn btn-success text-white px-4 whatsapp-btn text-uppercase py-2" href="https://alvo.chat/2yjn"><i class="fa-brands fa-whatsapp fa-lg"></i></a>
        ...
        <div class="offcanvas-body p-0">
            <ul class="navbar-nav all_product">
                ...
                <li class="nav-item dropdown">
                    ...
                    @endif
                    @if($categoryGroup['categories'])
                    <ul class="dropdown-menu bg-black position-static w-100 mb-0 py-0">
                        @foreach($categoryGroup['categories'] as $category)
                        <li class="nav-item">
