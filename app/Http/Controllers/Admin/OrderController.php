...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Order::select('orders.id', 'orders.id as order_number', 'users.first_name', 'payments.price', 'orders.status', 'orders.created_at')
            ...
            $columns = ['id', 'order_number', 'first_name', 'price', 'status', 'created_at'];
