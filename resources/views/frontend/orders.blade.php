    ...
    <div class="container">
        ...
        <div class="row">
            ...
            @if(count($orders) > 0)
                ...
                @endforeach
            @else
                <div class="text-center py-5 bg-white border border-secondary shadow-sm rounded">
                    <div class="mb-4 mt-3">
                        <i class="fa-solid fa-box-open text-muted opacity-50" style="font-size: 5rem;"></i>
                    </div>
                    <h4 class="text-dark fw-bold mb-2">No orders here yet!</h4>
                    <p class="text-muted mb-4">Looks like you haven't made your first purchase yet.</p>
                    <a href="{{ route('home') }}" class="btn btn-primary px-4 py-2 fw-bold mb-3">Start Shopping</a>
                </div>
            @endif
            </div>
        </div>
