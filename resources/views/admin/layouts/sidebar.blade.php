 <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="@if(Request::segment(2) == 'brands') active @endif treeview">
          <a href="#">
            <i class="fa fa-bold"></i> <span>Brand</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
           <ul class="treeview-menu">
            <li class="@if(Request::segment(2) == 'brands' && Request::segment(3) == '') active @endif"><a href="{{ route('admin.brands.index') }}"><i class="fa fa-circle-o"></i> List </a></li>
            <li class="@if(Request::segment(2) == 'brands' && Request::segment(3) == 'create') active @endif"><a href="{{ route('admin.brands.create') }}"><i class="fa fa-circle-o"></i> Create </a></li>
          </ul>
        </li>
