...
use App\Jobs\Backend\DesignationJob;
use App\Http\Requests\Backend\DesignationRequest;
...
class DesignationController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Designation::select('id', 'title', 'status')
                ->whereRaw($where_str, $where_params);
                
            $data_count = Designation::select('id')
                ->whereRaw($where_str, $where_params)
                ->count();
    ...
    public function store(DesignationRequest $request)
    {
        ...
        dispatch(new DesignationJob($params));
    ...
    public function delete(Request $request)
    {
        ...
        Designation::whereIn('id',$id)->delete();
